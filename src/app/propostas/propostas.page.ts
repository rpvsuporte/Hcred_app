...
export class PropostasPage  {
    ...
    // Função para quando iniciar a page (Melhor que o constructor e ngInit)
    ...
    // get's para exibir o título e aplicar background nos cards
    ...
    // Função para aplicar filtro e mudar o input
    ...
    onFiltroSelecionado() {
        ...
        this.valorFiltro = ''; // limpa campo ao mudar
    }

    // Função para aplicar máscara dependendo do tipo de input
    ...
    // Função para realizar fetch com o que foi digitado 
    ...
    // Função para consultar e exibir propostas
    ...
    // Função para trocar de página quando seleciona um status pelo dropdown
